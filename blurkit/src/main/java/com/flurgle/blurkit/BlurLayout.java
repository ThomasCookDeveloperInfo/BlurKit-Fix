...
public class BlurLayout extends FrameLayout {
    ...
    /** Reference to the view to blur */
    private int mViewToBlur;
    ...
    public BlurLayout(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mViewToBlur = a.getResourceId(R.styleable.BlurLayout_blk_toBlur, -1);
            if (mViewToBlur == -1) {
                throw new IllegalStateException("You must provide the id of the view to blur");
            }
        } finally {
            a.recycle();
        }
